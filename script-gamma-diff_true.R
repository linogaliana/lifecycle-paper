...
saveRDS(env, file = here::here("monte-carlo", "beta_fixed_true_diff.Rds"))
...
outfile <- "beta_fixed_diff_true.txt"
...
saveRDS(env, file = here::here("monte-carlo", "beta_fixed_diff_true.txt"))
