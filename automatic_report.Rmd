...
| $\epsilon' W \epsilon$ | `r output$NelderMead$NM_step2$value` | `rt(output$moments$moment_first_step$epsilon) %*% output$estimates$W_1 %*% output$moments$moment_first_step$epsilon` |
