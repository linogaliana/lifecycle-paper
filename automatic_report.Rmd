...
| $Q(\theta) = \frac{1}{M^2} \epsilon' W \epsilon$ | `r output$NelderMead$NM_step2$value/length(moments$moment_optimum$epsilon)` |
`r as.numeric(t(output$moments$moment_first_step$epsilon) %*% output$estimates$W_1 %*% output$moments$moment_first_step$epsilon)/length(moments$moment_optimum$epsilon)`
