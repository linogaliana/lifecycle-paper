...
plot_everything(dir = "modele1", scale_model = "log", scale_moment = "asinh", output = output_piste1,
                EP_2015 = EP_2015, population = population)
plot_everything(dir = "modele2", scale_model = "level", scale_moment = "asinh", output_piste2,
                EP_2015 = EP_2015, population = population)
plot_everything(dir = "modele3", scale_model = "log", scale_moment = "log", output_log,
                EP_2015 = EP_2015, population = population)
